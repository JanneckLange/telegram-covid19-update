...
var CoronaUpdate = /** @class */ (function () {
        ...
        var job = new CronJob(jobTime, function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.sendUpdate;
                        return [4 /*yield*/, this.getCasesPer100kIn7Days()];
                    case 1:
                        _a.apply(this, [(_b.sent()) + " F\u00E4lle auf 100.000 Einwohner in den letzten 7 Tagen."]);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    CoronaUpdate.prototype.getCasesPer100kIn7Days = function (locationId) {
        if (locationId === void 0) { locationId = '07316'; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise((function (resolve, reject) { return request(url, { json: true }, function (err, res, body) {
                        ...
                        resolve(_this.round(body.features[0].attributes.cases7_per_100k));
                    }); }))];
            });
        });
    };
    CoronaUpdate.prototype.sendUpdate = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.telegram.sendMessage(14417823, text)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CoronaUpdate.prototype.round = function (num) {
        return Math.round((num + Number.EPSILON) * 100) / 100;
    };
    return CoronaUpdate;
}());
exports.CoronaUpdate = CoronaUpdate;
